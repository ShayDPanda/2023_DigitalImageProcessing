        ...
        for y in range(oldY - 1):
            ...
            for x in range(oldX - 1):
                ...
                # Not Homogenous
                    ...
                    # x o x o x
                    # x x x x x
                    newImg[yOffset + 1][xOffset + 1]
                    newImg[yOffset + 3][xOffset + 1] = self.pixels[y][x + 1]
                    newImg[yOffset + 1][xOffset + 3] = self.pixels[y + 1][x]
                    newImg[yOffset + 3][xOffset + 3] = self.pixels[y + 1][x + 1]
                    ...
                    # x x x x x
                    # x x o x x
                    newImg[(y + 1) * 4][xOffset + 2] = newImg[yOffset + 2][xOffset + 2]
                    newImg[yOffset + 2][(x + 1) * 4] = newImg[yOffset + 2][xOffset + 2]
                    ...
                    thisX += 2
                    newImg[thisY][thisX] = newImg[thisY - 1][thisX]
